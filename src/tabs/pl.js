...
import { IF, AY, BRAND_SIGLE } from '../constants.js?v=20260716';
import { fE, fDshort } from '../utils/format.js?v=20260716';
import { nP, dTS } from '../utils/normalize.js?v=20260716';
import { $ } from '../utils/dom.js?v=20260716';
import { corsiForYear } from '../data/corsiForYear.js?v=20260716';
import { getSpendForProd, getRealSpend, attributeCampaignToYear } from '../data/helpers.js?v=20260716';
