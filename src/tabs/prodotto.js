...
import { IF, TL, SC } from '../constants.js?v=20260716';
import { fE, fEk, fD, fDshort } from '../utils/format.js?v=20260716';
import { cSt, bC, dTS } from '../utils/normalize.js?v=20260716';
import { $, escapeAttr } from '../utils/dom.js?v=20260716';
...
import {
  ...
  calcRitardo,
  calcOverlapDetail,
} from '../data/helpers.js?v=20260716';
import {
  getLastEdition,
  avgConversionDays,
  dropoutPct,
...
} from '../data/insights.js?v=20260716';
import { buildDailyChart } from '../charts/dailyChart.js?v=20260716';
import { drawFunnelChart, drawChannelsDonut, drawRevPerEdition } from '../charts/chartjs.js?v=20260716';
